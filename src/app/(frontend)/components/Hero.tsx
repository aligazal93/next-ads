...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative mt-[0px] flex min-h-[100svh] overflow-hidden lg:mt-[80px]"
    >
      <div className="relative z-[99] mx-auto flex  min-h-[100svh] w-full w-full items-center justify-center px-5 py-20 sm:px-8 md:py-24 lg:px-12">
        <div className="flex w-full max-w-[980px] flex-col items-center text-center">
          ...
          <h1
            ref={titleRef}
            className="max-w-[980px] text-[28px] font-bold leading-[1.70] tracking-[-0.03em] sm:text-[42px] md:text-[50px] lg:text-[64px] xl:text-[70px]"
          >
          ...
          <p
            ref={descriptionRef}
            className="mt-6 max-w-[800px] text-[12px] leading-[2] text-white sm:text-[16px] md:text-[15px] lg:text-[16px]"
          >
